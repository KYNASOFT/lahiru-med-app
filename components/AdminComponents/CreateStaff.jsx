    ...
    //   console.log(email,pass,repass);
      ...
      if(validEmail && validPass)
      {
          try{
            ...
            const res = await fetch('http://localhost:3000/api/staffregister',
            {
              method: "POST",
              headers: {
                "Content-Type": "application/json"
  ...
  return (
    <div className='my-20'>
        <div className='form-head'>
            <h1 className='main-title'>Add a Staff Member</h1>
            <h2 className='des-title'>This will add a Staff Member to the system</h2>
